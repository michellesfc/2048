/* Author: Michelle Gu
   http://www.openprocessing.org/sketch/149441
   
   How to play:
   Use the arrow keys to move the tiles. If two tiles with the same number collide, the tiles will merge into one tile with the total value of the tiles combined.

   Goal:
   To create a tile with a value of 2048.

  Note: Some tiles merge when not supposed to.
*/
